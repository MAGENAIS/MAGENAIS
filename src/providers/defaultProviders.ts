...
export const DEFAULT_PROVIDERS: ProviderConfig[] = [
  ...
  // ============================================================
  {
    ...
    isPreset: true,
    isBuiltIn: true,
    notes: "Independent infra, no signup — but its hosted models can hit Puter's own paid-usage paywall and show an \"Upgrade Now\" modal this app can't control. Disabled and excluded from the default chain; enable manually if you still want it as a last-resort extra.",
    timeoutMs: 30000,
    retries: 1,
  },
  {
  ...
  },
  {
    ...
    isPreset: true,
    isBuiltIn: true,
    notes: 'Real recordable audio file, no key needed — but same paywall-modal caveat as the text provider above. Disabled and excluded from the default chain; enable manually if wanted.',
    timeoutMs: 30000,
    retries: 1,
  },
  {
